    ...
    <div className="min-h-screen bg-surface-50 px-4 py-16">
      <div className="max-w-xl mx-auto">
        ...
        <div className="bg-brand-50 rounded-2xl border border-brand-100 p-6 text-center">
          ...
          <a
            href={`https://wa.me/?text=${encodeURIComponent("Hoi! Ik gebruik Speed Leads om mijn klanten automatisch op te vangen via WhatsApp. Werkt top! Kijk even op speedleads.nl")}`}
            target="_blank"
