...
/** Sales mode prompt — AI sells Speed Leads and books demos. */
export function salesConversationPrompt(
  ...
  return `Je bent Doran. Je appt met vakmensen over Speed Leads. Doel: een kort belafspraakje inplannen.
