...
export const metadata: Metadata = {
  title: "Verwerkersovereenkomst — Speed Leads",
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-surface max-w-none space-y-6 text-surface-700 text-sm leading-relaxed">
          ...
          <p>
            ...
            tussen Speed Leads (handelsnaam van Fryno, KvK 98018272) en de Klant, en regelt de verwerking van
            persoonsgegevens door Speed Leads als verwerker namens de Klant als verwerkingsverantwoordelijke.
          </p>

          <section>
            <h2 className="text-lg font-semibold text-surface-900 mt-8 mb-3">1. Definities</h2>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Verwerker:</strong> Speed Leads (Fryno), die persoonsgegevens verwerkt in opdracht van de Verwerkingsverantwoordelijke</li>
          ...
          <section>
            ...
            <p>
              ...
              door Speed Leads ten behoeve van de dienstverlening aan de Klant. De overeenkomst is van kracht gedurende
          ...
          <section>
            ...
            <p>Speed Leads verwerkt persoonsgegevens voor de volgende doeleinden:</p>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            ...
            <p>Speed Leads verplicht zich om:</p>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            ...
            <p>
              Speed Leads maakt gebruik van de volgende subverwerkers voor het leveren van de dienst:
            </p>
          ...
          <section>
            ...
            <p>
              ...
              Speed Leads gebruik van de Standard Contractual Clauses (SCCs) zoals goedgekeurd door de Europese
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Speed Leads te voorzien van correcte en actuele instructies met betrekking tot de verwerking</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Speed Leads ondersteunt de Klant bij het afhandelen van verzoeken van betrokkenen op grond van de AVG,
          ...
          <section>
            ...
            <p>Speed Leads treft de volgende technische en organisatorische maatregelen:</p>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            ...
            <p>
              In het geval van een datalek dat betrekking heeft op persoonsgegevens, stelt Speed Leads de Klant hiervan
          ...
          <section>
            ...
            <p>
              ...
              controleren. Speed Leads zal hieraan redelijke medewerking verlenen. Audits vinden plaats na voorafgaande
          ...
          <section>
            ...
            <p>
              Deze overeenkomst is van kracht zolang Speed Leads persoonsgegevens verwerkt namens de Klant. Na
