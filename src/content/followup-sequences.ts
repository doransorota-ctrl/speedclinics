/**
 * Speed Leads — Follow-up Sequences
 *
...
export const trialSequence = {
  ...
  welcome: {
    delay: "immediate",
    channel: "whatsapp",
    nl: `Hoi {{name}}! Welkom bij Speed Leads. 🎉
...
Heb je alvast vragen? Stuur ze hier!`,
    en: `Hi {{name}}! Welcome to Speed Leads.
...
Is Speed Leads al actief bij je? Zo niet, laat het me weten — dan zetten we het vandaag nog aan.`,
...
Is Speed Leads active yet? If not, let me know — we'll set it up today.`,
  },
  ...
  day7: {
    delay: "7d",
    channel: "whatsapp",
    nl: `Hoi {{name}}, je bent nu een week bezig met Speed Leads.
...
Je hebt nog 7 dagen in je proefperiode.`,
    en: `Hi {{name}}, you've been using Speed Leads for a week now.
...
Wil je Speed Leads blijven gebruiken? Dan hoef je niks te doen — het loopt automatisch door.

Wil je stoppen? Stuur me even een berichtje. Geen gedoe.

Maar bedenk: elke dag zonder Speed Leads is een dag waarop je klanten misloopt die je concurrent wél oppakt.`,
    en: `Hi {{name}}, your trial ends in 2 days.

Want to keep using Speed Leads? You don't need to do anything — it continues automatically.

Want to stop? Just message me. No hassle.

But remember: every day without Speed Leads is a day where you miss customers your competitor picks up.`,
  },
...
Hoe bevalt het? Ik zie dat Speed Leads {{leads_count}} leads voor je heeft opgepakt in de afgelopen 2 weken.
...
How was it? I can see Speed Leads picked up {{leads_count}} leads for you over the past 2 weeks.
...
export const demoSequence = {
  ...
  confirmation: {
    delay: "immediate",
    channel: "whatsapp",
    nl: `Hoi {{name}}, bedankt voor je interesse in Speed Leads!
...
In de tussentijd: heb je specifieke vragen? Stuur ze hier!`,
    en: `Hi {{name}}, thanks for your interest in Speed Leads!
...
Ik kan je in 15 minuten laten zien hoe Speed Leads werkt. Wanneer schikt het je?`,
    en: `Hi {{name}}, just checking in — did you get my message about the demo?

I can show you how Speed Leads works in 15 minutes. When works for you?`,
  },
