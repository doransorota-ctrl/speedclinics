...
export const metadata: Metadata = {
  title: "Algemene Voorwaarden — Speed Clinics",
};
        ...
        <div className="prose prose-surface max-w-none space-y-6 text-surface-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Speed Clinics:</strong> de dienstverlener, aanbieder van het Speed Clinics platform</li>
              <li><strong>Klant:</strong> de ondernemer/vakman die gebruik maakt van Speed Clinics</li>
          ...
          <section>
            ...
            <p>
              Deze algemene voorwaarden zijn van toepassing op alle diensten van Speed Clinics. Door je aan te melden ga je akkoord met deze voorwaarden.
            </p>
            <p>
          ...
          <section>
            ...
            <p>Speed Clinics biedt de volgende diensten aan:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Speed Clinics (€79/maand excl. BTW):</strong> automatische leadopvolging via WhatsApp bij gemiste oproepen, leadkwalificatie, en optionele agenda-integratie</li>
              <li><strong>Website Pakket (€500 eenmalig + €39/maand excl. BTW):</strong> professionele website inclusief hosting en beheer</li>
              <li><strong>Compleet Pakket (€500 eenmalig + €118/maand excl. BTW):</strong> website + Speed Clinics gecombineerd</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Het Speed Clinics en Compleet pakket bevatten een gratis proefperiode van 14 dagen. Na afloop wordt het abonnement automatisch verlengd tegen het geldende tarief, tenzij je voor het einde van de proefperiode opzegt.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Speed Clinics is niet aansprakelijk voor indirecte schade, gevolgschade, of gederfde winst</li>
          ...
          <section>
            ...
            <p>
              Alle intellectuele eigendomsrechten op het Speed Clinics platform, inclusief software, design, en content, berusten bij Speed Clinics. De website die wij voor je bouwen wordt jouw eigendom na volledige betaling.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Speed Clinics verwerkt persoonsgegevens van jouw klanten (leads) namens jou als verwerker. De voorwaarden voor deze verwerking zijn vastgelegd in onze{" "}
