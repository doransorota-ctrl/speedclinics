  ...
  return (
    <div>
      ...
      <p className="text-surface-500 mt-1">
        {hasSpeedLeads ? "Welkom bij je Speed Leads dashboard." : "Welkom bij je portaal."}
      </p>
      ...
      {/* Setup checklist (Speed Leads only) */}
      ...
      {business?.plan === "website" && (
        <div className="mt-6 bg-brand-50 border border-brand-200 rounded-xl p-5 flex items-center justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-xs text-brand-700">Voeg Speed Leads toe en mis nooit meer een oproep of WhatsApp-bericht.</p>
          </div>
      ...
      {business?.plan === "speed-leads" && (
        <div className="mt-6 bg-brand-50 border border-brand-200 rounded-xl p-5 flex items-center justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-xs text-brand-700">Combineer Speed Leads met een op maat gemaakte website.</p>
          </div>
          <Link href="/portal/upgrade" className="btn-secondary text-sm">
            Bekijk opties →
          </Link>
