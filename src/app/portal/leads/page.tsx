      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-surface-500 mt-1">
            Alle gesprekken die Speed Leads voor je heeft opgevangen.
          </p>
        </div>
      </div>
        ...
        <div className="mt-6 bg-white rounded-xl border border-surface-200 p-12 text-center">
          ...
          <p className="text-sm text-surface-500 mt-2 max-w-sm mx-auto leading-relaxed">
            {!business?.forwarding_confirmed
              ...
              : "Zodra iemand je belt en je neemt niet op, vangt Speed Leads de klant op via WhatsApp. Het gesprek verschijnt dan hier."}
          </p>
            ...
            <div className="mt-6">
              {business?.twilio_number && (
                <div className="bg-surface-50 rounded-xl p-4 inline-block mb-4">
                  <p className="text-xs text-surface-400 mb-1">Je Speed Leads nummer</p>
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <p className="text-sm font-medium text-brand-700">
                  Speed Leads is actief en wacht op je eerste gemiste oproep
                </p>
              </div>
            </div>
          )}
