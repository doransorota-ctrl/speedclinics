...
const GREETING_TEXT = process.env.SALES_GREETING_TEXT ||
  "Hoi, ik ben Doran van Clŷniq. Ik had je gebeld. Als jij niet opneemt stuurt m'n systeem de beller een appje en plant een afspraak in. Scheelt je gemiste klussen. 5 minuutjes bellen?";
