...
/** Sales mode prompt — AI sells Speed Clinics and books demos. */
export function salesConversationPrompt(
  ...
  return `Je bent Doran. Je appt met vakmensen over Speed Clinics. Doel: een kort belafspraakje inplannen.
