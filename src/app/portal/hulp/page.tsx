...
const sections = [
  {
    title: "Hoe werkt Speed Leads?",
    items: [
      {
        q: "Wat gebeurt er als iemand mij belt?",
        a: "Als je niet opneemt, stuurt Speed Leads binnen 5 seconden een WhatsApp naar de beller. De AI voert het gesprek, stelt vragen over het probleem, en plant een afspraak in je agenda.",
      },
      {
    ...
    items: [
      {
        ...
        a: "Ga naar Instellingen en klik op 'Koppel Google Agenda'. Je logt in met je Google account en geeft toestemming. Speed Leads kan dan je beschikbaarheid checken en afspraken inplannen.",
      },
      {
        q: "Kan Speed Leads mijn afspraken zien?",
        a: "Speed Leads checkt alleen wanneer je vrij of bezet bent. We lezen geen details van bestaande afspraken.",
      },
      {
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-surface-500 mt-1">Alles wat je moet weten over Speed Leads.</p>
      </div>
      ...
      {business?.twilio_number && (
        <div className="bg-white rounded-xl border border-surface-200 p-5 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-semibold text-surface-900">Je Speed Leads nummer</p>
